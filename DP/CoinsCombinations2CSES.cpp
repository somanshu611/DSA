...
// There a trick(a logical way) to do that. We can pick coins in order(like first all 2Rs coins, then 3Rs coins, and so on...) so that, we don't choose that coin again after picking coins of another denomination.
